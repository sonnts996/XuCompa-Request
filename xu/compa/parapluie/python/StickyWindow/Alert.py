...
class Alert(StickyWindow.StickyWindow):
    ...
    def __init__(self, parent: QWidget, tpe: str = Parapluie.Alert_Information):
        ...
        close.setIcon(Parapluie.Resource.defaultIcon(Parapluie.Icon_Cancel_Svg))
    ...
    def eventFilter(self, a0: QtCore.QObject, a1: QtCore.QEvent):
        ...
        return super(Alert, self).eventFilter(a0, a1)

    def minimizedFollowParent(self):
        if not self.inHideMode():
            super(Alert, self).minimizedFollowParent()
