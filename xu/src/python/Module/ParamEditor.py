...
class ParamEditor(QTreeView):
    ...
    def open_menu(self, position):
        ...
        delete_action = QAction(QIcon(':/icons/delete_forever.svg'), '&Delete key', self)
        delete_action.setStatusTip('Delete')

        new_action = QAction(QIcon(':/icons/create_new_folder.svg'), '&Add key', self)
        ...
        if action == delete_action:
            ...
            if self.is_list(self.jsonData, link, 0, len(link)):
                ...
                Util.Style.applyStyle(input_name)
